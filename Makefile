...
constraints.txt: base.in postgresql.in memcached.in monitoring.in test.in dev.in
	pip-compile -o constraints.txt base.in postgresql.in memcached.in monitoring.in test.in dev.in
